...
When a property affecting the knob display is changed, `DrawKnob()` is called, and the entire knob is redrawn. However, this normally happens much less frequently than rotating the knob with a mouse drag.
