...
#### DrawingBrush
A Drawing Brush extends the functionality of an Image Brush. As well as images, it can contain text, shapes and media. Shapes and text can be drawn directly using XAML or codebehind. Again there is the disadvantage that the background does not rotate with the knob.
```
<custom:Knob.FillBrush>
    <DrawingBrush>
